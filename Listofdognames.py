# Name: Chiagozie Kingsley-Ibeh
# Prog Purpose: This program demonstrates how to manipulate a list, including:
#   finding number of items in a list, sorting the list, adding/removing items,
...
def main():
    ...
    print("\nRemove a dog name rather than position in the list:")
    print(dogs)
